...
function MenuItemRow({
  ...
  return (
    <div
      className={`flex items-center justify-between border border-line rounded-chit p-4 ${
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <button type="button" onClick={() => setEditing(true)} className="text-sm text-accent font-medium">
          Edit
        </button>
        <button type="button" onClick={onDelete} className="text-sm text-muted">
          Delete
        </button>
      </div>
    </div>
